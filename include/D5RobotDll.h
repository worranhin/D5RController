...
D5R_API ErrorCode __stdcall CallJointsMoveAbsolute(D5Robot *instance, const Joints j);
D5R_API ErrorCode __stdcall CallJointsMoveRelative(D5Robot *instance, const Joints j);
